package rpg.entities.enemies.Skeleton;
...
public class Skeleton extends Enemy {
    ...
    @Override
    public void getLoot() {
        System.out.println("The Skeleton drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El Skeleton te ataca con su espada y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El Skeleton invoca a otros  y te hacen 6 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
