...
/**
 * Enumerado que representa los diferentes tipos de armas en el juego
 */
public enum WeaponType {
    SWORD,      // Representa una espada, un arma de corte utilizada para el combate cuerpo a cuerpo.
